export { SettingsProvider, useSettings, getAccentClasses, generateUsername, generateUsernameWithPhone, getEmployeePermissionGroupName, loadHrmRoleGroups, setRoleGroupsCache, isUserInRoleGroup, isUserInAnyRoleGroup, hasModulePermission, getConfiguredApprover, getMaterialCoordinator, getMaterialApprover, loadApprovalConfig, syncApprovalConfigFromDb, saveApprovalConfig, setApprovalConfigCache, saveDefaultSnapshot, loadDefaultSnapshot } from './SettingsContext';
