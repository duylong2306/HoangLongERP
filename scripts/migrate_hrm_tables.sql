-- ============================================================
-- Hoàng Long ERP — HRM Tables (FULL SCHEMA)
-- Flat columns — không dùng JSONB
-- ============================================================
...
CREATE TABLE IF NOT EXISTS public.hrm_performance_criteria (
  ...
  criteria        TEXT DEFAULT '[]',  -- JSON array stored as TEXT
  created_at      TIMESTAMPTZ DEFAULT now(),
  updated_at      TIMESTAMPTZ DEFAULT now()
);
...
DROP TRIGGER IF EXISTS trg_hrm_leave_coefficients_updated_at ON public.hrm_leave_coefficients;
...
DROP TRIGGER IF EXISTS trg_hrm_leaves_updated_at ON public.hrm_leaves;
...
DROP TRIGGER IF EXISTS trg_hrm_payroll_records_updated_at ON public.hrm_payroll_records;
...
DROP TRIGGER IF EXISTS trg_hrm_employee_errors_updated_at ON public.hrm_employee_errors;
...
DROP TRIGGER IF EXISTS trg_hrm_holidays_updated_at ON public.hrm_holidays;
